...
class Config(Config):
    def __init__(self, num_gpus=2):
        ...
        # Evaluate the pretrained model on practically the whole dataset (i.e. on 99.95% of it)
        # This might recreate the RE number from the paper
        self.num_epochs = 0
        self.train_ratio = 0.0005
